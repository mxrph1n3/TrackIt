-- Finance ecosystem: budgets, account balances, task monetization, auto-sync trigger
-- Run in Supabase SQL Editor after finance_module.sql
-- Compatible with existing finance_accounts / transactions tables
...
-- ---------------------------------------------------------------------------
-- Account stored balance (kept in sync via trigger)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Transaction provenance (idempotent ecosystem inserts)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Balance sync trigger (server-side source of truth)
-- ---------------------------------------------------------------------------
...
-- Backfill account balances from transaction history
